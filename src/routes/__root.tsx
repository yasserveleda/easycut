...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SalonFlow — Agendamento para salões e barbearias" },
      { name: "description", content: "Plataforma premium de agendamento online para barbearias e salões de beleza." },
      { property: "og:title", content: "SalonFlow" },
      { property: "og:description", content: "Agendamento online elegante e simples para o seu salão." },
